...
* Sourcecode: https://github.com/marcrobledo.com/RomPatcher.js
* License: MIT
*/

import BinFile from './modules/BinFile.js';
import IPS from './modules/RomPatcher.format.ips.js';
import BPS from './modules/RomPatcher.format.bps.js';
import UPS from './modules/RomPatcher.format.ups.js';
import APS from './modules/RomPatcher.format.aps_n64.js';
import APSGBA from './modules/RomPatcher.format.aps_gba.js';
import RUP from './modules/RomPatcher.format.rup.js';
import PPF from './modules/RomPatcher.format.ppf.js';
import PMSR from './modules/RomPatcher.format.pmsr.js';
import VCDIFF from './modules/RomPatcher.format.vcdiff.js';
...
export { BinFile, IPS, BPS, UPS, APS, APSGBA, RUP, PPF, PMSR, VCDIFF };