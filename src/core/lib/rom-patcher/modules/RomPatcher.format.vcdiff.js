...
function VCDIFF_Parser(binFile, offset)
{
	...
	this.readU8 = binFile.readU8.bind(this);
	this.readU32 = binFile.readU32.bind(this);
	this.skip = binFile.skip.bind(this);
	this.isEOF = binFile.isEOF.bind(this);
	this.seek = binFile.seek.bind(this);
}
